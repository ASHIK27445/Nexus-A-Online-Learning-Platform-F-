...
const AddCourse = () => {
    ...
    const handleForm = (e) =>{
        ...
        const instructorName = form.InsName.value
        const instructorTitle = form.InsTitle.value
        const instructorAvatar = form.InsAvatar.value
        const email = form.email.value

        const courseTypes = ["top", "premium", "trending", "popular"]
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-950 via-neutral-950 to-stone-950 flex items-center justify-center p-6 relative">
      ...
      <div className="w-full max-w-2xl relative">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-1">Create Course</h1>
          <p className="text-sm text-gray-500">Fill in the course details below</p>
        </div>

        {/* Form Card */}
        <form onSubmit={handleForm}  className="bg-zinc-900 rounded-lg border border-zinc-800 shadow-2xl">
